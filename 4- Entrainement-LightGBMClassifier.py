...
# MAGIC - Compare trials in the [MLflow experiment](#mlflow/experiments/4239471033684089).
...
input_data_path = mlflow.artifacts.download_artifacts(run_id="77843dad18f94cbb8a75be243965eaf1", artifact_path="data", dst_path=input_temp_dir)
...
supported_cols = ["Qualité_isolation_menuiseries", "Qualité_isolation_murs", "Qualité_isolation_plancher_bas", "Année_construction", "Type_bâtiment", "Qualité_isolation_enveloppe", "Surface_habitable_logement", "Conso_5_usages_é_finale"]
...
num_imputers = []
num_imputers.append(("impute_mean", SimpleImputer(), ["Année_construction", "Conso_5_usages_é_finale", "Qualité_isolation_enveloppe", "Qualité_isolation_menuiseries", "Qualité_isolation_murs", "Qualité_isolation_plancher_bas", "Surface_habitable_logement", "Type_bâtiment"]))
...
numerical_transformers = [("numerical", numerical_pipeline, ["Qualité_isolation_menuiseries", "Qualité_isolation_murs", "Qualité_isolation_plancher_bas", "Année_construction", "Type_bâtiment", "Qualité_isolation_enveloppe", "Surface_habitable_logement", "Conso_5_usages_é_finale"])]
...
categorical_one_hot_transformers = [("onehot", one_hot_pipeline, ["Qualité_isolation_enveloppe", "Qualité_isolation_menuiseries", "Qualité_isolation_murs", "Qualité_isolation_plancher_bas", "Type_bâtiment"])]
...
# MAGIC - All the runs are logged under [this MLflow experiment](#mlflow/experiments/4239471033684089)
...
def objective(params):
  with mlflow.start_run(experiment_id="4239471033684089") as mlflow_run:
...
space = {
  "colsample_bytree": 0.5063055822860618,
  "lambda_l1": 54.07825842199626,
  "lambda_l2": 3.4559340672736525,
  "learning_rate": 0.3649364222708656,
  "max_bin": 357,
  "max_depth": 12,
  "min_child_samples": 68,
  "n_estimators": 517,
  "num_leaves": 51,
  "path_smooth": 58.06591974579815,
  "subsample": 0.7653885606119116,
  "random_state": 133483038,
}
...
if shap_enabled:
    ...
    train_sample = X_train.sample(n=min(100, X_train.shape[0]), random_state=133483038).fillna(mode)

    # Sample some rows from the validation set to explain. Increase the sample size for more thorough results.
    example = X_val.sample(n=min(100, X_val.shape[0]), random_state=133483038).fillna(mode)
...
displayHTML(f"<a href=#mlflow/experiments/4239471033684089/runs/{ mlflow_run.info.run_id }/artifactPath/model> Link to model run page </a>")
